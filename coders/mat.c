...
static const char const *const MonthsTab[12]={"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"};
static const char const *const DayOfWTab[7]={"Sun","Mon","Tue","Wed","Thu","Fri","Sat"};
